...
function getDetailsForIndia(callback) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var _b, err, response;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, await_to_js_1.default(axios.default.get(indiaURl))];
                case 1:
                    _b = _c.sent(), err = _b[0], response = _b[1];
                    callback((_a = response === null || response === void 0 ? void 0 : response.data) === null || _a === void 0 ? void 0 : _a.statewise);
                    return [2 /*return*/];
            }
        });
    });
